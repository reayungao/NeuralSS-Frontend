...
export const StartupLoader: React.FC = () => {
  return (
    <div className="fixed inset-0 bg-gray-50 dark:bg-gray-900 flex flex-col items-center justify-center z-50">
      <div className="flex items-center space-x-3 text-gray-800 dark:text-gray-100 text-xl mb-4">
      ...
      <p className="text-gray-500 dark:text-gray-400">Please wait, this may take a moment.</p>
    </div>
  );
};
